alias: `link-invitation-accepted`
...
`
<h1>Hi {{ name }},</h1>
<p>{{user_invitee_name}} ({{user_invitee_email}}) has accepted your invitation to link their company <strong>{{workspace_invitee}}</strong>.</p>
<!-- Action -->
